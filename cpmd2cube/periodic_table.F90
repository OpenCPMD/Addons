!------------------------------------------------------------------------------!
!  cpmd2cube:  data definitions related to the periodic table of elements.     !
...
!
      PRIVATE
      PUBLIC :: init_periodic_table, atom, nelem, ptable
!
      TYPE atom
        CHARACTER (len=2)  :: symbol
        CHARACTER (len=14) :: name
        INTEGER :: number
        REAL (dbl) :: mass            ! in formula units
        REAL (dbl) :: covalent_radius ! in Angstroms
        REAL (dbl) :: vdw_radius      ! in Angstroms
        INTEGER :: e_conv(0:3)
        REAL (dbl), POINTER :: slater_exp(:,:)
...
!
      SUBROUTINE init_periodic_table
        IMPLICIT NONE
        REAL (dbl), PARAMETER :: z = 0.0_dbl, dum = 2.0_dbl
! Dummy   
        ptable(0) %symbol = 'X '
        ptable(0) %name = 'Dummy'
        ptable(0) %number = 0
...
! Lithium
        ...
        ptable(3) %number = 3
        ptable(3) %mass = 6.93900_dbl
        ptable(3) %covalent_radius = 1.2300_dbl
        ptable(3) %vdw_radius = 1.82_dbl
...
! Beryllium
        ...
        ptable(4) %number = 4
        ptable(4) %mass = 9.01220_dbl
        ptable(4) %covalent_radius = 0.9000_dbl
        ptable(4) %vdw_radius = dum
...
! Boron
        ...
        ptable(5) %name = 'Boron'
        ptable(5) %number = 5
        ptable(5) %mass = 10.81100_dbl
        ptable(5) %covalent_radius = 0.8200_dbl
        ptable(5) %vdw_radius = dum
...
! Carbon
        ...
        ptable(6) %number = 6
        ptable(6) %mass = 12.01115_dbl
        ptable(6) %covalent_radius = 0.7700_dbl
        ptable(6) %vdw_radius = 1.7_dbl
...
! Nitrogen
        ...
        ptable(7) %number = 7
        ptable(7) %mass = 14.00670_dbl
        ptable(7) %covalent_radius = 0.7500_dbl
        ptable(7) %vdw_radius = 1.55_dbl
...
! Oxygen
        ...
        ptable(8) %number = 8
        ptable(8) %mass = 15.99940_dbl
        ptable(8) %covalent_radius = 0.7300_dbl
        ptable(8) %vdw_radius = 1.52_dbl
...
! Neon
        ...
        ptable(10) %name = 'Neon'
        ptable(10) %number = 10
        ptable(10) %mass = 20.18300_dbl
        ptable(10) %covalent_radius = 0.7100_dbl
        ptable(10) %vdw_radius = 1.54_dbl
...
! Sodium
        ...
        ptable(11) %number = 11
        ptable(11) %mass = 22.98980_dbl
        ptable(11) %covalent_radius = 1.5400_dbl
        ptable(11) %vdw_radius = 2.27_dbl
...
! Magnesium
        ...
        ptable(12) %number = 12
        ptable(12) %mass = 24.31200_dbl
        ptable(12) %covalent_radius = 1.3600_dbl
        ptable(12) %vdw_radius = 1.73_dbl
...
! Aluminium
        ...
        ptable(13) %number = 13
        ptable(13) %mass = 26.98150_dbl
        ptable(13) %covalent_radius = 1.1800_dbl
        ptable(13) %vdw_radius = dum
...
! Silicon
        ...
        ptable(14) %number = 14
        ptable(14) %mass = 28.08600_dbl
        ptable(14) %covalent_radius = 1.1100_dbl
        ptable(14) %vdw_radius = 2.1_dbl
...
! Phosphorus
        ...
        ptable(15) %number = 15
        ptable(15) %mass = 30.97380_dbl
        ptable(15) %covalent_radius = 1.0600_dbl
        ptable(15) %vdw_radius = 1.8_dbl
...
! Potassium
        ...
        ptable(19) %number = 19
        ptable(19) %mass = 39.10200_dbl
        ptable(19) %covalent_radius = 2.0300_dbl
        ptable(19) %vdw_radius = 2.75_dbl
...
! Calcium
        ...
        ptable(20) %number = 20
        ptable(20) %mass = 40.08000_dbl
        ptable(20) %covalent_radius = 1.7400_dbl
        ptable(20) %vdw_radius = dum
...
! Scandium
        ...
        ptable(21) %number = 21
        ptable(21) %mass = 44.95600_dbl
        ptable(21) %covalent_radius = 1.4400_dbl
        ptable(21) %vdw_radius = dum
...
! Titanium
        ...
        ptable(22) %number = 22
        ptable(22) %mass = 47.90000_dbl
        ptable(22) %covalent_radius = 1.3200_dbl
        ptable(22) %vdw_radius = dum
...
! Vanadium
        ...
        ptable(23) %number = 23
        ptable(23) %mass = 50.94200_dbl
        ptable(23) %covalent_radius = 1.2200_dbl
        ptable(23) %vdw_radius = dum
...
! Chromium
        ...
        ptable(24) %number = 24
        ptable(24) %mass = 51.99600_dbl
        ptable(24) %covalent_radius = 1.1800_dbl
        ptable(24) %vdw_radius = dum
...
! Manganese
        ...
        ptable(25) %number = 25
        ptable(25) %mass = 54.93800_dbl
        ptable(25) %covalent_radius = 1.1700_dbl
        ptable(25) %vdw_radius = dum
...
! Iron
        ...
        ptable(26) %name = 'Iron'
        ptable(26) %number = 26
        ptable(26) %mass = 55.84700_dbl
        ptable(26) %covalent_radius = 1.1700_dbl
        ptable(26) %vdw_radius = dum
...
! Cobalt
        ...
        ptable(27) %number = 27
        ptable(27) %mass = 58.93300_dbl
        ptable(27) %covalent_radius = 1.1600_dbl
        ptable(27) %vdw_radius = dum
...
! Nickel
        ...
        ptable(28) %number = 28
        ptable(28) %mass = 58.71000_dbl
        ptable(28) %covalent_radius = 1.1500_dbl
        ptable(28) %vdw_radius = 1.63_dbl
...
! Copper
        ...
        ptable(29) %number = 29
        ptable(29) %mass = 63.54000_dbl
        ptable(29) %covalent_radius = 1.1700_dbl
        ptable(29) %vdw_radius = 1.4_dbl
...
! Zinc
        ...
        ptable(30) %name = 'Zinc'
        ptable(30) %number = 30
        ptable(30) %mass = 65.37000_dbl
        ptable(30) %covalent_radius = 1.2500_dbl
        ptable(30) %vdw_radius = 1.39_dbl
...
! Gallium
        ...
        ptable(31) %number = 31
        ptable(31) %mass = 69.72000_dbl
        ptable(31) %covalent_radius = 1.2600_dbl
        ptable(31) %vdw_radius = 1.07_dbl
...
! Germanium
        ...
        ptable(32) %number = 32
        ptable(32) %mass = 72.59000_dbl
        ptable(32) %covalent_radius = 1.2200_dbl
        ptable(32) %vdw_radius = dum
...
! Kryton
        ptable(36) %symbol = 'Kr'
        ptable(36) %name = 'Kryton'
        ptable(36) %number = 36
        ptable(36) %mass = 83.80000_dbl
        ptable(36) %covalent_radius = 1.1200_dbl
        ptable(36) %vdw_radius = 2.02_dbl
...
! Rubidium
        ...
        ptable(37) %number = 37
        ptable(37) %mass = 85.47000_dbl
        ptable(37) %covalent_radius = 2.1600_dbl
        ptable(37) %vdw_radius = dum
...
! Strontium
        ...
        ptable(38) %number = 38
        ptable(38) %mass = 87.62000_dbl
        ptable(38) %covalent_radius = 1.9100_dbl
        ptable(38) %vdw_radius = dum
...
! Yttrium
        ...
        ptable(39) %number = 39
        ptable(39) %mass = 88.90500_dbl
        ptable(39) %covalent_radius = 1.6200_dbl
        ptable(39) %vdw_radius = dum
...
! Zirconium
        ...
        ptable(40) %number = 40
        ptable(40) %mass = 91.22000_dbl
        ptable(40) %covalent_radius = 1.4500_dbl
        ptable(40) %vdw_radius = dum
...
! Molybdenum
        ...
        ptable(42) %number = 42
        ptable(42) %mass = 95.94000_dbl
        ptable(42) %covalent_radius = 1.3000_dbl
        ptable(42) %vdw_radius = dum
...
! Technetium
        ...
        ptable(43) %number = 43
        ptable(43) %mass = 98.00000_dbl
        ptable(43) %covalent_radius = 1.2700_dbl
        ptable(43) %vdw_radius = dum
...
! Ruthenium
        ...
        ptable(44) %number = 44
        ptable(44) %mass = 101.07000_dbl
        ptable(44) %covalent_radius = 1.2500_dbl
        ptable(44) %vdw_radius = dum
...
! Rhodium
        ...
        ptable(45) %number = 45
        ptable(45) %mass = 102.90500_dbl
        ptable(45) %covalent_radius = 1.2500_dbl
        ptable(45) %vdw_radius = dum
...
! Palladium
        ...
        ptable(46) %number = 46
        ptable(46) %mass = 106.40000_dbl
        ptable(46) %covalent_radius = 1.2800_dbl
        ptable(46) %vdw_radius = 1.63_dbl
...
! Silver
        ...
        ptable(47) %number = 47
        ptable(47) %mass = 107.87000_dbl
        ptable(47) %covalent_radius = 1.3400_dbl
        ptable(47) %vdw_radius = 1.72_dbl
...
! Cadmium
        ...
        ptable(48) %number = 48
        ptable(48) %mass = 112.40000_dbl
        ptable(48) %covalent_radius = 1.4800_dbl
        ptable(48) %vdw_radius = 1.58_dbl
...
! Indium
        ...
        ptable(49) %number = 49
        ptable(49) %mass = 114.82000_dbl
        ptable(49) %covalent_radius = 1.4400_dbl
        ptable(49) %vdw_radius = 1.93_dbl
...
! Tin   
        ...
        ptable(50) %name = 'Tin'
        ptable(50) %number = 50
        ptable(50) %mass = 118.69000_dbl
        ptable(50) %covalent_radius = 1.4100_dbl
        ptable(50) %vdw_radius = 2.17_dbl;
...
! Xenon
        ...
        ptable(54) %number = 54
        ptable(54) %mass = 131.30000_dbl
        ptable(54) %covalent_radius = 1.3100_dbl
        ptable(54) %vdw_radius = 2.16_dbl
...
! Cesium
        ...
        ptable(55) %number = 55
        ptable(55) %mass = 132.90500_dbl
        ptable(55) %covalent_radius = 2.3500_dbl
        ptable(55) %vdw_radius = dum
...
! Barium
        ...
        ptable(56) %number = 56
        ptable(56) %mass = 137.34000_dbl
        ptable(56) %covalent_radius = 1.9800_dbl
        ptable(56) %vdw_radius = dum
...
! Lanthanum
        ...
        ptable(57) %number = 57
        ptable(57) %mass = 138.91000_dbl
        ptable(57) %covalent_radius = 1.6900_dbl
        ptable(57) %vdw_radius = dum
...
! Cerium
        ...
        ptable(58) %number = 58
        ptable(58) %mass = 140.12000_dbl
        ptable(58) %covalent_radius = 1.6500_dbl
        ptable(58) %vdw_radius = dum
...
! Praseodymium
        ...
        ptable(59) %number = 59
        ptable(59) %mass = 140.90700_dbl
        ptable(59) %covalent_radius = 1.6500_dbl
        ptable(59) %vdw_radius = dum
...
! Neodymium
        ...
        ptable(60) %number = 60
        ptable(60) %mass = 144.24000_dbl
        ptable(60) %covalent_radius = 1.6400_dbl
        ptable(60) %vdw_radius = dum
...
! Promethium
        ...
        ptable(61) %number = 61
        ptable(61) %mass = 147.00000_dbl
        ptable(61) %covalent_radius = 1.6300_dbl
        ptable(61) %vdw_radius = dum
...
! Samarium
        ...
        ptable(62) %number = 62
        ptable(62) %mass = 150.35000_dbl
        ptable(62) %covalent_radius = 1.6200_dbl
        ptable(62) %vdw_radius = dum
...
! Europium
        ...
        ptable(63) %number = 63
        ptable(63) %mass = 151.96000_dbl
        ptable(63) %covalent_radius = 1.8500_dbl
        ptable(63) %vdw_radius = dum
...
! Gadolinium
        ...
        ptable(64) %number = 64
        ptable(64) %mass = 157.25000_dbl
        ptable(64) %covalent_radius = 1.6100_dbl
        ptable(64) %vdw_radius = dum
...
! Terbium
        ...
        ptable(65) %number = 65
        ptable(65) %mass = 158.92400_dbl
        ptable(65) %covalent_radius = 1.5900_dbl
        ptable(65) %vdw_radius = dum
...
! Dysprosium
        ...
        ptable(66) %number = 66
        ptable(66) %mass = 162.50000_dbl
        ptable(66) %covalent_radius = 1.5900_dbl
        ptable(66) %vdw_radius = dum
...
! Erbium
        ...
        ptable(68) %number = 68
        ptable(68) %mass = 167.26000_dbl
        ptable(68) %covalent_radius = 1.5700_dbl
        ptable(68) %vdw_radius = dum
...
! Thulium
        ...
        ptable(69) %number = 69
        ptable(69) %mass = 168.93400_dbl
        ptable(69) %covalent_radius = 1.5600_dbl
        ptable(69) %vdw_radius = dum
...
! Ytterbium
        ...
        ptable(70) %number = 70
        ptable(70) %mass = 173.04000_dbl
        ptable(70) %covalent_radius = 1.5600_dbl
        ptable(70) %vdw_radius = dum
...
! Lutetium
        ...
        ptable(71) %number = 71
        ptable(71) %mass = 174.97000_dbl
        ptable(71) %covalent_radius = 1.5600_dbl
        ptable(71) %vdw_radius = dum
...
! Hafnium
        ...
        ptable(72) %number = 72
        ptable(72) %mass = 178.49000_dbl
        ptable(72) %covalent_radius = 1.4400_dbl
        ptable(72) %vdw_radius = dum
...
! Tungsten
        ...
        ptable(74) %number = 74
        ptable(74) %mass = 183.85000_dbl
        ptable(74) %covalent_radius = 1.3000_dbl
        ptable(74) %vdw_radius = dum
...
! Rhenium
        ...
        ptable(75) %number = 75
        ptable(75) %mass = 186.20000_dbl
        ptable(75) %covalent_radius = 1.2800_dbl
        ptable(75) %vdw_radius = dum
...
! Osmium
        ...
        ptable(76) %number = 76
        ptable(76) %mass = 190.20000_dbl
        ptable(76) %covalent_radius = 1.2600_dbl
        ptable(76) %vdw_radius = dum
...
! Iridium
        ...
        ptable(77) %number = 77
        ptable(77) %mass = 192.20000_dbl
        ptable(77) %covalent_radius = 1.2700_dbl
        ptable(77) %vdw_radius = dum
...
! Platinum
        ...
        ptable(78) %number = 78
        ptable(78) %mass = 195.09000_dbl
        ptable(78) %covalent_radius = 1.3000_dbl
        ptable(78) %vdw_radius = 1.72_dbl
...
! Gold 
        ...
        ptable(79) %name = 'Gold'
        ptable(79) %number = 79
        ptable(79) %mass = 196.96700_dbl
        ptable(79) %covalent_radius = 1.3400_dbl
        ptable(79) %vdw_radius = 1.66_dbl
...
! Mercury
        ...
        ptable(80) %number = 80
        ptable(80) %mass = 200.59000_dbl
        ptable(80) %covalent_radius = 1.4900_dbl
        ptable(80) %vdw_radius = 1.55_dbl
...
! Thallium
        ...
        ptable(81) %number = 81
        ptable(81) %mass = 204.37000_dbl
        ptable(81) %covalent_radius = 1.4800_dbl
        ptable(81) %vdw_radius = 1.96_dbl
...
! Lead
        ...
        ptable(82) %name = 'Lead'
        ptable(82) %number = 82
        ptable(82) %mass = 207.19000_dbl
        ptable(82) %covalent_radius = 1.4700_dbl
        ptable(82) %vdw_radius = 2.02_dbl
...
! Bismuth
        ...
        ptable(83) %number = 83
        ptable(83) %mass = 208.98000_dbl
        ptable(83) %covalent_radius = 1.4600_dbl
        ptable(83) %vdw_radius = dum
...
! Polonium
        ...
        ptable(84) %number = 84
        ptable(84) %mass = 209.00000_dbl
        ptable(84) %covalent_radius = 1.4600_dbl
        ptable(84) %vdw_radius = dum
...
! Astatine
        ...
        ptable(85) %number = 85
        ptable(85) %mass = 210.00000_dbl
        ptable(85) %covalent_radius = 1.4500_dbl
        ptable(85) %vdw_radius = dum
...
! Radon
        ...
        ptable(86) %number = 86
        ptable(86) %mass = 222.00000_dbl
        ptable(86) %covalent_radius = z
        ptable(86) %vdw_radius = dum
...
! Francium
        ...
        ptable(87) %number = 87
        ptable(87) %mass = 223.00000_dbl
        ptable(87) %covalent_radius = z
        ptable(87) %vdw_radius = dum
...
! Uranium
        ...
        ptable(92) %number = 92
        ptable(92) %mass = 238.02900_dbl
        ptable(92) %covalent_radius = 1.4200_dbl
        ptable(92) %vdw_radius = 1.96_dbl
...
! Plutonium
        ...
        ptable(94) %number = 94
        ptable(94) %mass = 244.0000_dbl
        ptable(94) %covalent_radius = z
        ptable(94) %vdw_radius = dum
...
! Americum
        ...
        ptable(95) %number = 95
        ptable(95) %mass = 243.0000_dbl
        ptable(95) %covalent_radius = z
        ptable(95) %vdw_radius = dum
...
! Curium
        ...
        ptable(96) %number = 96
        ptable(96) %mass = 247.0000_dbl
        ptable(96) %covalent_radius = z
        ptable(96) %vdw_radius = dum
...
! Berkelium
        ...
        ptable(97) %number = 97
        ptable(97) %mass = 251.0000_dbl
        ptable(97) %covalent_radius = z
        ptable(97) %vdw_radius = dum
...
! Californium
        ...
        ptable(98) %number = 98
        ptable(98) %mass = 252.0000_dbl
        ptable(98) %covalent_radius = z
        ptable(98) %vdw_radius = dum
...
! Einsteinium
        ...
        ptable(99) %number = 99
        ptable(99) %mass = 252.0000_dbl
        ptable(99) %covalent_radius = z
        ptable(99) %vdw_radius = dum
...
! Fermium
        ...
        ptable(100) %mass = 257.0000_dbl
        ptable(100) %covalent_radius = z
        ptable(100) %vdw_radius = dum
...
! Mendelevium
        ...
        ptable(101) %mass = 258.0000_dbl
        ptable(101) %covalent_radius = z
        ptable(101) %vdw_radius = dum
...
! Nobelium
        ...
        ptable(102) %mass = 259.0000_dbl
        ptable(102) %covalent_radius = z
        ptable(102) %vdw_radius = dum
...
! Lawrencium
        ...
        ptable(103) %mass = 260.0000_dbl
        ptable(103) %covalent_radius = z
        ptable(103) %vdw_radius = dum
